...
export default function CoursesPage() {
  ...
  const [addForm, setAddForm] = useState({ course_title: "", course_code: "", level: "", department_id: "" });
  ...
  const handleAddCourse = async (e: React.FormEvent) => {
    ...
    if (res.status) {
      ...
      setAddForm({ course_title: "", course_code: "", level: "", department_id: "" });
            ...
            <DialogContent>
              ...
              <form ref={addFormRef} onSubmit={handleAddCourse} className="space-y-4">
                ...
                <select
                    ...
                    className="border rounded px-3 py-2 w-full dark:bg-gray-900 dark:text-gray-100"
                    required
                >
